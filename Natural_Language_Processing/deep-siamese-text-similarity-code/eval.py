...
tf.flags.DEFINE_string("checkpoint_dir", "runs/1562167973", "Checkpoint directory from training run")
tf.flags.DEFINE_string("eval_filepath", "validation.txt", "Evaluate on this data (Default: None)")
tf.flags.DEFINE_string("vocab_filepath", "runs/1562167973/checkpoints/vocab", "Load training time vocabulary (Default: None)")
tf.flags.DEFINE_string("model", "runs/1562167973/checkpoints/model-60000", "Load trained model checkpoint (Default: None)")
